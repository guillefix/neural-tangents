#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Wed Oct 30 19:37:06 GMT 2019      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 100 --mpi=pmi2 --mem-per-cpu=10000 nice -n 10 /users/guillefix/anaconda3/envs/tf-gpu2/bin/python3.7 sample_funs.py --num_samples 4000 --train_size 10000
