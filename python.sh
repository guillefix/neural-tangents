#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Fri Nov 15 18:48:29 GMT 2019      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 300 --mpi=pmi2 --mem-per-cpu=5000 nice -n 10 /users/guillefix/anaconda3/envs/venv/bin/python sample_funs.py --train_size 10000 --train_time 100000
